...
export default function UpdatePartyDialog({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      description: initialPartyDescription,
    },
  });
  ...
  return (
    <>
      ...
      <Dialog.Content className="fixed left-1/2 top-1/2 z-50 max-h-[85vh] w-360 -translate-x-1/2 -translate-y-1/2 rounded-20 bg-white p-30 shadow-default focus:outline-none">
